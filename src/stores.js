...
export const sensors = readable(
  [{
    ...
    {
      name: 'Household Surveys (Facebook)',
      id: 'fb-survey',
      tooltipText: 'Percentage of Facebook survey respondents reporting COVID-like symptoms',
    ...
    {
      name: 'Community Surveys (Facebook)',
      id: 'fb-survey',
      tooltipText: 'Percentage of Facebook survey respondents reporting COVID-like symptoms in their community',
      mapTitleText: 'Percentage of Facebook survey respondents reporting COVID-like symptoms in their community',
      chartTitleText: 'Percentage of Facebook survey respondents reporting COVID-like symptoms in their community',
      yAxis: 'Percentage',
      format: 'percent',
      signal: 'wip_smoothed_hhcmnty',
      levels: ['county', 'msa', 'state'],
      minTime: 20200415,
      maxTime: 20200517,
      mean: 25,
    ...
    },
    {
      ...
      tooltipText: 'Combination of all indicators available at this geographic level',
      mapTitleText: 'Combination of all available indicators',
      chartTitleText: 'Combination of all available indicators',
      yAxis: 'Combined value (arbitrary scale)',
      format: 'raw',
      signal: 'wip_combo_geo7_day_glrm_l2adj',
      levels: ['county', 'msa', 'state'],
      minTime: 20200301,
      maxTime: 20200516,
      mean: 0.731132,
