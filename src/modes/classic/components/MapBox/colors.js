...
export function determineMinMax(
  ...
  return metaDataManager.getValueDomainCompatibility(sensorEntry, level, signalOptions, { useMax, enforceZeroLike });
}
 ...
 * @param {import('../../stores/constants').CasesOrDeathOptions} signalOptions
 */
export function generateLabels(metaDataManager, sensorEntry, level, colorScale, signalOptions, small = false) {
